...
#else
    // Unsupported system
    #error This operating system is not supported by the Hybrid Squirrel Module
#endif
...
#define SQMOD_NAME "Hybrid Squirrel Module"
...
#define _NLMAX(t) std::numeric_limits<t>::max()
...
#define SQMOD_STACK_SIZE        4096

#ifndef NDEBUG
    #define SQMOD_DEBUG_LEVEL   0
#else
    #define SQMOD_DEBUG_LEVEL   3
#endif
...
#define SQMOD_SHARED_BUFFER_SZ 8192
