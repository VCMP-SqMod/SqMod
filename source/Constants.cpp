...
static const EnumElement g_SkinEnum[] = {
    {_SC("Unknown"),                  SQMOD_UNKNOWN},
    {_SC("Tommy_vercetti"),           SQMOD_SKIN_TOMMY_VERCETTI},
    ...
    {_SC("Golf_guy_a"),               SQMOD_SKIN_GOLF_GUY_A},
    {_SC("Bum_lady_a"),               SQMOD_SKIN_BUM_LADY_A},
    {_SC("Bum_lady_b"),               SQMOD_SKIN_BUM_LADY_B},
    {_SC("Punk_a"),                   SQMOD_SKIN_PUNK_A},
    {_SC("Lawyer"),                   SQMOD_SKIN_LAWYER},
    {_SC("Spanish_lady_a"),           SQMOD_SKIN_SPANISH_LADY_A},
    {_SC("Spanish_lady_b"),           SQMOD_SKIN_SPANISH_LADY_B},
    {_SC("Cool_guy_a"),               SQMOD_SKIN_COOL_GUY_A},
    {_SC("Arabic_guy"),               SQMOD_SKIN_ARABIC_GUY},
    {_SC("Beach_lady_a"),             SQMOD_SKIN_BEACH_LADY_A},
    {_SC("Beach_lady_b"),             SQMOD_SKIN_BEACH_LADY_B},
    {_SC("Beach_guy_a"),              SQMOD_SKIN_BEACH_GUY_A},
    {_SC("Beach_guy_b"),              SQMOD_SKIN_BEACH_GUY_B},
    {_SC("Office_lady_a"),            SQMOD_SKIN_OFFICE_LADY_A},
    {_SC("Waitress_a"),               SQMOD_SKIN_WAITRESS_A},
    {_SC("Food_lady"),                SQMOD_SKIN_FOOD_LADY},
    {_SC("Prostitute_a"),             SQMOD_SKIN_PROSTITUTE_A},
    {_SC("Bum_lady_c"),               SQMOD_SKIN_BUM_LADY_C},
    {_SC("Bum_guy_a"),                SQMOD_SKIN_BUM_GUY_A},
    {_SC("Garbageman_a"),             SQMOD_SKIN_GARBAGEMAN_A},
    {_SC("Taxi_driver_a"),            SQMOD_SKIN_TAXI_DRIVER_A},
    {_SC("Hatian_a"),                 SQMOD_SKIN_HATIAN_A},
    {_SC("Criminal_a"),               SQMOD_SKIN_CRIMINAL_A},
    {_SC("Hood_lady"),                SQMOD_SKIN_HOOD_LADY},
    {_SC("Granny_a"),                 SQMOD_SKIN_GRANNY_A},
    {_SC("Business_man_a"),           SQMOD_SKIN_BUSINESS_MAN_A},
    {_SC("Church_guy"),               SQMOD_SKIN_CHURCH_GUY},
    {_SC("Club_lady"),                SQMOD_SKIN_CLUB_LADY},
    {_SC("Church_lady"),              SQMOD_SKIN_CHURCH_LADY},
    {_SC("Pimp"),                     SQMOD_SKIN_PIMP},
    {_SC("Beach_lady_c"),             SQMOD_SKIN_BEACH_LADY_C},
    {_SC("Beach_guy_c"),              SQMOD_SKIN_BEACH_GUY_C},
    {_SC("Beach_lady_d"),             SQMOD_SKIN_BEACH_LADY_D},
    {_SC("Beach_guy_d"),              SQMOD_SKIN_BEACH_GUY_D},
    {_SC("Business_man_b"),           SQMOD_SKIN_BUSINESS_MAN_B},
    {_SC("Prostitute_b"),             SQMOD_SKIN_PROSTITUTE_B},
    {_SC("Bum_lady_d"),               SQMOD_SKIN_BUM_LADY_D},
    {_SC("Bum_guy_b"),                SQMOD_SKIN_BUM_GUY_B},
    {_SC("Hatian_b"),                 SQMOD_SKIN_HATIAN_B},
    {_SC("Construction_worker_a"),    SQMOD_SKIN_CONSTRUCTION_WORKER_A},
    {_SC("Punk_b"),                   SQMOD_SKIN_PUNK_B},
    {_SC("Prostitute_c"),             SQMOD_SKIN_PROSTITUTE_C},
    {_SC("Granny_b"),                 SQMOD_SKIN_GRANNY_B},
    {_SC("Punk_c"),                   SQMOD_SKIN_PUNK_C},
    {_SC("Business_man_c"),           SQMOD_SKIN_BUSINESS_MAN_C},
    {_SC("Spanish_lady_c"),           SQMOD_SKIN_SPANISH_LADY_C},
    {_SC("Spanish_lady_d"),           SQMOD_SKIN_SPANISH_LADY_D},
    {_SC("Cool_guy_b"),               SQMOD_SKIN_COOL_GUY_B},
    {_SC("Business_man_d"),           SQMOD_SKIN_BUSINESS_MAN_D},
    {_SC("Beach_lady_e"),             SQMOD_SKIN_BEACH_LADY_E},
    {_SC("Beach_guy_e"),              SQMOD_SKIN_BEACH_GUY_E},
    {_SC("Beach_lady_f"),             SQMOD_SKIN_BEACH_LADY_F},
    {_SC("Beach_guy_f"),              SQMOD_SKIN_BEACH_GUY_F},
    {_SC("Construction_worker_b"),    SQMOD_SKIN_CONSTRUCTION_WORKER_B},
    {_SC("Golf_guy_b"),               SQMOD_SKIN_GOLF_GUY_B},
    {_SC("Golf_lady"),                SQMOD_SKIN_GOLF_LADY},
    {_SC("Golf_guy_c"),               SQMOD_SKIN_GOLF_GUY_C},
    {_SC("Beach_lady_g"),             SQMOD_SKIN_BEACH_LADY_G},
    {_SC("Beach_guy_g"),              SQMOD_SKIN_BEACH_GUY_G},
    {_SC("Office_lady_b"),            SQMOD_SKIN_OFFICE_LADY_B},
    {_SC("Business_man_e"),           SQMOD_SKIN_BUSINESS_MAN_E},
    {_SC("Business_man_f"),           SQMOD_SKIN_BUSINESS_MAN_F},
    {_SC("Prostitute_d"),             SQMOD_SKIN_PROSTITUTE_D},
    {_SC("Bum_lady_e"),               SQMOD_SKIN_BUM_LADY_E},
    {_SC("Bum_guy_c"),                SQMOD_SKIN_BUM_GUY_C},
    {_SC("Spanish_guy"),              SQMOD_SKIN_SPANISH_GUY},
    {_SC("Taxi_driver_b"),            SQMOD_SKIN_TAXI_DRIVER_B},
    {_SC("Gym_lady"),                 SQMOD_SKIN_GYM_LADY},
    {_SC("Gym_guy"),                  SQMOD_SKIN_GYM_GUY},
    {_SC("Skate_lady"),               SQMOD_SKIN_SKATE_LADY},
    {_SC("Skate_guy"),                SQMOD_SKIN_SKATE_GUY},
    {_SC("Shopper_a"),                SQMOD_SKIN_SHOPPER_A},
    {_SC("Shopper_b"),                SQMOD_SKIN_SHOPPER_B},
    {_SC("Tourist_a"),                SQMOD_SKIN_TOURIST_A},
    {_SC("Tourist_b"),                SQMOD_SKIN_TOURIST_B},
    {_SC("Cuban_a"),                  SQMOD_SKIN_CUBAN_A},
    {_SC("Cuban_b"),                  SQMOD_SKIN_CUBAN_B},
    {_SC("Hatian_c"),                 SQMOD_SKIN_HATIAN_C},
    {_SC("Hatian_d"),                 SQMOD_SKIN_HATIAN_D},
    {_SC("Shark_a"),                  SQMOD_SKIN_SHARK_A},
    {_SC("Shark_b"),                  SQMOD_SKIN_SHARK_B},
    {_SC("Diaz_guy_a"),               SQMOD_SKIN_DIAZ_GUY_A},
    {_SC("Diaz_guy_b"),               SQMOD_SKIN_DIAZ_GUY_B},
    {_SC("Dbp_security_a"),           SQMOD_SKIN_DBP_SECURITY_A},
    {_SC("Dbp_security_b"),           SQMOD_SKIN_DBP_SECURITY_B},
    {_SC("Biker_a"),                  SQMOD_SKIN_BIKER_A},
    {_SC("Biker_b"),                  SQMOD_SKIN_BIKER_B},
    {_SC("Vercetti_guy_a"),           SQMOD_SKIN_VERCETTI_GUY_A},
    {_SC("Vercetti_guy_b"),           SQMOD_SKIN_VERCETTI_GUY_B},
    {_SC("Undercover_cop_a"),         SQMOD_SKIN_UNDERCOVER_COP_A},
    {_SC("Undercover_cop_b"),         SQMOD_SKIN_UNDERCOVER_COP_B},
    {_SC("Undercover_cop_c"),         SQMOD_SKIN_UNDERCOVER_COP_C},
    {_SC("Undercover_cop_d"),         SQMOD_SKIN_UNDERCOVER_COP_D},
    {_SC("Undercover_cop_e"),         SQMOD_SKIN_UNDERCOVER_COP_E},
    {_SC("Undercover_cop_f"),         SQMOD_SKIN_UNDERCOVER_COP_F},
    {_SC("Rich_guy"),                 SQMOD_SKIN_RICH_GUY},
    {_SC("Cool_guy_c"),               SQMOD_SKIN_COOL_GUY_C},
    {_SC("Prostitute_e"),             SQMOD_SKIN_PROSTITUTE_E},
    {_SC("Prostitute_f"),             SQMOD_SKIN_PROSTITUTE_F},
    {_SC("Love_fist_a"),              SQMOD_SKIN_LOVE_FIST_A},
    {_SC("Ken_rosenburg"),            SQMOD_SKIN_KEN_ROSENBURG},
    {_SC("Candy_suxx"),               SQMOD_SKIN_CANDY_SUXX},
    {_SC("Hilary"),                   SQMOD_SKIN_HILARY},
    {_SC("Love_fist_b"),              SQMOD_SKIN_LOVE_FIST_B},
    {_SC("Phil"),                     SQMOD_SKIN_PHIL},
    {_SC("Rockstar_guy"),             SQMOD_SKIN_ROCKSTAR_GUY},
    {_SC("Sonny"),                    SQMOD_SKIN_SONNY},
    {_SC("Lance_a"),                  SQMOD_SKIN_LANCE_A},
    {_SC("Mercades_a"),               SQMOD_SKIN_MERCADES_A},
    {_SC("Love_fist_c"),              SQMOD_SKIN_LOVE_FIST_C},
    {_SC("Alex_srub"),                SQMOD_SKIN_ALEX_SRUB},
    {_SC("Lance_cop"),                SQMOD_SKIN_LANCE_COP},
    {_SC("Lance_b"),                  SQMOD_SKIN_LANCE_B},
    {_SC("Cortez"),                   SQMOD_SKIN_CORTEZ},
    {_SC("Love_fist_d"),              SQMOD_SKIN_LOVE_FIST_D},
    {_SC("Columbian_guy_a"),          SQMOD_SKIN_COLUMBIAN_GUY_A},
    {_SC("Hilary_robber"),            SQMOD_SKIN_HILARY_ROBBER},
    {_SC("Mercades_b"),               SQMOD_SKIN_MERCADES_B},
    {_SC("Cam"),                      SQMOD_SKIN_CAM},
    {_SC("Cam_robber"),               SQMOD_SKIN_CAM_ROBBER},
    {_SC("Phil_one_arm"),             SQMOD_SKIN_PHIL_ONE_ARM},
    {_SC("Phil_robber"),              SQMOD_SKIN_PHIL_ROBBER},
    {_SC("Cool_guy_d"),               SQMOD_SKIN_COOL_GUY_D},
    {_SC("Pizzaman"),                 SQMOD_SKIN_PIZZAMAN},
    {_SC("Taxi_driver_c"),            SQMOD_SKIN_TAXI_DRIVER_C},
    {_SC("Taxi_driver_d"),            SQMOD_SKIN_TAXI_DRIVER_D},
    {_SC("Sailor_a"),                 SQMOD_SKIN_SAILOR_A},
    {_SC("Sailor_b"),                 SQMOD_SKIN_SAILOR_B},
    {_SC("Sailor_c"),                 SQMOD_SKIN_SAILOR_C},
    {_SC("Chef"),                     SQMOD_SKIN_CHEF},
    {_SC("Criminal_b"),               SQMOD_SKIN_CRIMINAL_B},
    {_SC("French_guy"),               SQMOD_SKIN_FRENCH_GUY},
    {_SC("Garbageman_b"),             SQMOD_SKIN_GARBAGEMAN_B},
    {_SC("Hatian_e"),                 SQMOD_SKIN_HATIAN_E},
    {_SC("Waitress_b"),               SQMOD_SKIN_WAITRESS_B},
    {_SC("Sonny_guy_a"),              SQMOD_SKIN_SONNY_GUY_A},
    {_SC("Sonny_guy_b"),              SQMOD_SKIN_SONNY_GUY_B},
    {_SC("Sonny_guy_c"),              SQMOD_SKIN_SONNY_GUY_C},
    {_SC("Columbian_guy_b"),          SQMOD_SKIN_COLUMBIAN_GUY_B},
    {_SC("Thug_a"),                   SQMOD_SKIN_THUG_A},
    {_SC("Beach_guy_h"),              SQMOD_SKIN_BEACH_GUY_H},
    {_SC("Garbageman_c"),             SQMOD_SKIN_GARBAGEMAN_C},
    {_SC("Garbageman_d"),             SQMOD_SKIN_GARBAGEMAN_D},
    {_SC("Garbageman_e"),             SQMOD_SKIN_GARBAGEMAN_E},
    {_SC("Tranny"),                   SQMOD_SKIN_TRANNY},
    {_SC("Thug_b"),                   SQMOD_SKIN_THUG_B},
    {_SC("Spandex_guy_a"),            SQMOD_SKIN_SPANDEX_GUY_A},
    {_SC("Spandex_guy_b"),            SQMOD_SKIN_SPANDEX_GUY_B},
    {_SC("Stripper_a"),               SQMOD_SKIN_STRIPPER_A},
    {_SC("Stripper_b"),               SQMOD_SKIN_STRIPPER_B},
    {_SC("Stripper_c"),               SQMOD_SKIN_STRIPPER_C},
    {_SC("Store_clerk"),              SQMOD_SKIN_STORE_CLERK},
